...
beautiful.init("/home/alex/.config/awesome/themes/zenburn/theme.lua")
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "y", function () awful.layout.inc(layouts,  1) end),
    ...
    awful.key({ modkey },            "space", function () awful.util.spawn("Dmenu") end),
...
awful.rules.rules = {
    ...
    { rule = { class = "Exe" },
      properties = { floating = true } },
    { rule = { class = "Quake Live" },
      properties = { floating = true } },
    { rule = { class = "QUAKE LIVE Launcher" },
      properties = { floating = true } },
